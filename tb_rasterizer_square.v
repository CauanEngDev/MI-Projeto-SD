...
module tb_rasterizer_square;
    ...
    // Agora recebe color_index (0-255) + palette_sel em vez do RGB direto;
    // a cor final esperada é o conteúdo de palette_mem[{sel,idx}].
    task draw_square(
    ...
    // pintada com 'c' (RGB resolvido pela paleta), e nada fora dela foi
    // tocado (checagem por amostragem)
    task check_region(
    ...
    initial begin
        ...
        // Popula a paleta simulada: paleta 0 (palette_sel=0), indices 0-3
        // com as mesmas cores puras usadas nos testes originais.
        palette_mem[{1'b0, 8'd0}] = 9'b111000000; // vermelho puro
        palette_mem[{1'b0, 8'd1}] = 9'b000111000; // verde puro
        palette_mem[{1'b0, 8'd2}] = 9'b000000111; // azul puro
        palette_mem[{1'b0, 8'd3}] = 9'b101010101; // padrão listrado
        // Índice 0 na paleta 1, pra validar que palette_sel realmente
        // troca de banco (Teste 5, novo)
        palette_mem[{1'b1, 8'd0}] = 9'b010101010;
        ...
        draw_square(9'd10, 8'd10, 9'd15, 8'd15, 8'd0, 1'b0); // vermelho puro
        ...
        draw_square(9'd50, 8'd40, 9'd45, 8'd35, 8'd1, 1'b0); // verde puro
        check_region(9'd45, 9'd50, 8'd35, 8'd40, 9'b000111000);

        // Teste 3: um único pixel (v0 == v1) -- caso extremo
        draw_square(9'd100, 8'd100, 9'd100, 8'd100, 8'd2, 1'b0); // azul puro
        ...
        draw_square(9'd0, 8'd0, 9'd50, 8'd30, 8'd3, 1'b0);
        check_region(9'd0, 9'd50, 8'd0, 8'd30, 9'b101010101);

        // Teste 5 (novo): mesmo índice de cor (0), mas na paleta 1 -- valida
        // que palette_sel realmente seleciona um banco diferente da palette_ram
        draw_square(9'd200, 8'd200, 9'd205, 8'd205, 8'd0, 1'b1);
        check_region(9'd200, 9'd205, 8'd200, 8'd205, 9'b010101010);
